...
| 3 | LiPo Battery | 3.7 V 500 mAh, JST connector matching expansion board | 1 | $2-4 | Always-awake firmware — charge between sessions |
| 4 | Tactile Switch (12 mm, tall cap) | 12×12×7.3 mm, 160–260 gF, through-hole | 2 | $0.50 | Tall caps for gloved-hand use |
| 5 | Switch Caps (colored) | 12 mm round caps: Green (SAVE_POINT), Red (DEL_POINT) | 2 | $0.50 | Color-coded per function |
